 ...
 */
exports.setTypes = function(typeOptions) {
...
*/
exports.summarize = function(colsToSum, colsToConcat, delim, rowCountColumn) {
  var table = this.value;
...
/**
  ...
  */
exports.filter = function(column, operator, value, caseSensitive)
{
  var found = [];
  var matchCase = false;
...
/**
  toLookup(keyColumn)
  */
exports.toLookup = function(keyColumn)
{
  var table = this.value;
...
exports.joinAsArray = function(saveColumn, srcColumn, joinTable, joinColumn)
{
  var table = this.value;
...
exports.joinAsSummary = function(saveColumn, srcColumn, joinTable, joinColumn, colsToSum, colsToConcat, delim, rowCountColumn)
{
  var table = this.value;
  var lookup = new this(joinTable).toLookup(joinColumn);
...
exports.values = function(column, unique) {
  var table = this.value;
...
function mergeProperties(target, src) {
  for (var prop in src) {
